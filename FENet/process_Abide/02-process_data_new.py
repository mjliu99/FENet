...
# root_folder = '/data/'
root_folder = 'F:/桌面/学习资料/学姐实验/BrainGNN/BrainGNN_Pytorch-main/data_aal/'
...
def main():
    ...
    # 计算特征向量(矢量化连通网络)
    fea_corr = Reader.get_networks(subject_IDs, iter_no='', kind='correlation', atlas_name=atlas) #(1035, 200, 200)aal的话是116个节点
